...
@RestController
@RequestMapping("/api/your-byke-kafka")
public class YourBykeKafkaResource {
    private final Logger log = LoggerFactory.getLogger(YourBykeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public YourBykeKafkaResource(KafkaProperties kafkaProperties) {
